...
import { analyzeWorkloadForPartitioning } from '../../api'; // Import the API function
import '../../css/WorkloadAnalyzer.css';

function WorkloadAnalyzerForPartitioning() {
                            ...
                            {loading && !data.length ? (
                                ...
                                data.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td><div className="detail">{item['Where Uses']}</div></td>
                                        <td><div className="detail">{item['Join Uses']}</div></td>
                                    </tr>
                                ))
                            ) : (
                                <tr>
...
export default WorkloadAnalyzerForPartitioning;
